        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageRepresentationBase64 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductArchives", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductArchives_CategoryArchives_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductArchives_CategoryId",
